...
public class CarPictureBean {
    private static final Size DEFAULT_GAUSSIAN_BLUR_SIZE = new Size(5,5);
    ...
    private static final int DEFAULT_THRESH = 50;
    private static final Mat DEFAULT_KERNEL = getStructuringElement(Imgproc.MORPH_RECT, new Size(7, 7));
